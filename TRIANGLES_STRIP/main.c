...
void Desenha(void){
	...
	glBegin(GL_TRIANGLE_STRIP); //coordenadas linha
		glVertex2f(30, 80); //ponto1 T1
		glVertex2f(120, 80); //ponto 2 T1
		glVertex2f(80, 180); //ponto 3 T1
		glVertex2f(150, 180); //ponto 4 T2
		glVertex2f(180, 30); //ponto 5 T3
	glEnd();
